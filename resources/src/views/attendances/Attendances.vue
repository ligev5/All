      ...
      <el-form ref="form" :model="form" label-width="80px">
        ...
        <el-form-item label="考勤状态">
          <el-radio-group v-model="form.city">
            <el-radio v-for="item in city" :label="item" name="type"></el-radio>
          </el-radio-group>
        </el-form-item>
      </el-form>
    </el-card>
...
<script>
import { getDepartment, getAttendances } from "../../untils/api/attendances"
export default {
  data() {
    return {
      departmentList: [],
  ...
  methods: {
    ...
    getAttendances() {
      getAttendances(this.page).then((res) => {
        console.log(res)
        this.attendancesList = res.data.data.data.rows
  ...
  created() {
    this.getDepartment(), this.getAttendances()
  },
  mounted() {},
  components: {},
  computed: {},
